...
class RewardsBombs():
    def __init__(self):
        ...
        pygame.display.set_caption("Rewards and bombs")
    ...
    def draw_score(self):
        score_surface = self.font.render(f"Rewards: {self.score}", True, (255, 255, 255))
        self.screen.blit(score_surface, (10, 10))

    def game_over(self):
        message_surface = self.font.render(f"Game over! Rewards: {self.score}", True, (255, 0, 0))
